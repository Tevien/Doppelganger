...
from dpplgngr.scores.privacy import PrivacyEvaluation
...
parser.add_argument('--etlconfig', type=str, help='Path to the ETL configuration file.',
                    default='/home/sbenson/sw/Doppelganger/config/etl_amc_hpc_snowflake_equiv.json')
...
luigi.build([ConvertLargeFiles(etl_config=etl_config), 
             ...
             PrivacyEvaluation(gen_config=gen_config, etl_config=etl_config)
             
             ], 
workers=1, local_scheduler=True, no_lock=False, log_level='INFO')
