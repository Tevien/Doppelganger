...
def calculateMAGGIC(data:pd.DataFrame, columns:Dict[str, str],
    ...
    '''
    Caculated the MAGGIC score predicting 3-years death in heart failure
    ...
    maggic : pd.DataFrame,
        ...
        and an index equal to the index of `data`.
    '''
    ...
    MAGGIC='maggic'; MAGGIC_RISK3='maggic (3-years risk of death)'
